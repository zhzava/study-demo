...
public class StringZhuanShuzu {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
        String scalarOid1 = "1.3.6.1.2.1.1.5.0";
        
		String[] varBindings = { scalarOid1 };
		/*System.out.print("String[] varBindings =");
		for (String str : varBindings) {
			System.out.println(str);
		}*/
		Vector requestScaVectorRead = getVariableBindings(varBindings);
