...
public class MultiThreadedTrapReceverV3 implements CommandResponder{

	private String username1 = "zhairiyun";
    private String username2 = "user2";
    private String username3 = "user3";
    private String username4 = "user4";
    private String authPassword = "zhairiyun1";
    private String privPassword = "zhairiyun2";
    ...
    public MultiThreadedTrapReceverV3() {  
    ...
    private void init() throws UnknownHostException, IOException {  
        ...
        */
        ...
        //监听端的 ip地址 和 监听端口号
        listenAddress = GenericAddress.parse(System.getProperty(  
                "snmp4j.listenAddress", "udp:192.168.0.109/162"));
    ...
    public static void main(String[] args) {  
    	MultiThreadedTrapReceverV3 multithreadedtrapreceiver = new MultiThreadedTrapReceverV3();  
